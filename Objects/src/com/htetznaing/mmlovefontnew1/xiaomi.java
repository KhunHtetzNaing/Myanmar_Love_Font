...
public class xiaomi extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmlovefontnew1", "com.htetznaing.mmlovefontnew1.xiaomi");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmlovefontnew1", "com.htetznaing.mmlovefontnew1.xiaomi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmlovefontnew1.xiaomi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setText((Object)("	ပထမဦးစြာ Install ကိုႏွိပ္ျပီး ေဖာင့္ေရြးထည့္ေပးပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး System Font မွာ Myanmar Love Font ကိုေရြးေပးလိုက္ပါ။ သို့မဟုတ္ Theme ထဲက Font မွာ Myanmar Love Font ကိုေရြးျပီး Apply ေပးပါ။"));
...
mostCurrent._tlb.setText((Object)("Xiaomi[MIUI]"));
 //BA.debugLineNum = 70;BA.debugLine="tlb.Color = Colors.rgb(244, 67, 54)";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 241;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful M";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 219;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Heart+Font");
