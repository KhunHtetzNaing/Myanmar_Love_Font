...
public class slidemenu extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.htetznaing.mmlovefontnew1.slidemenu");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.htetznaing.mmlovefontnew1.slidemenu.class).invoke(this, new Object[] {null});
        else
...
com.htetznaing.mmlovefontnew1.slidemenu._actionitem _item = null;
...
_item = new com.htetznaing.mmlovefontnew1.slidemenu._actionitem();
