...
public class samsung extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmlovefontnew1", "com.htetznaing.mmlovefontnew1.samsung");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmlovefontnew1", "com.htetznaing.mmlovefontnew1.samsung");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmlovefontnew1.samsung", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 121;BA.debugLine="File.Copy(File.DirAssets,\"Love.apk\",File.DirRootE";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Love.apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Love.apk");
 //BA.debugLineNum = 122;BA.debugLine="Msgbox(\"1. Install Fone App\" & CRLF & \"2. After";
...
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Love.apk");
 //BA.debugLineNum = 125;BA.debugLine="i.SetType(\"application/vnd.android.package-arch";
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 ...
 //BA.debugLineNum = 130;BA.debugLine="If File.Exists(File.DirRootExternal,\"Love.apk\") =";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Love.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 131;BA.debugLine="File.Delete(File.DirRootExternal,\"Love.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Love.apk");
 };
...
_i.Initialize("","");
 //BA.debugLineNum = 136;BA.debugLine="i.SetComponent(\"com.android.settings/.flipfont.Fo";
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 146;BA.debugLine="If File.Exists(File.DirRootExternal,\"Love.apk\") =";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Love.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 147;BA.debugLine="File.Delete(File.DirRootExternal,\"Love.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Love.apk");
 };
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 214;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful M";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 192;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Heart+Font");
