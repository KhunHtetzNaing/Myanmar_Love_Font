...
public class vivo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmlovefontnew1", "com.htetznaing.mmlovefontnew1.vivo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmlovefontnew1", "com.htetznaing.mmlovefontnew1.vivo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmlovefontnew1.vivo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.mmlovefontnew1.main _main = null;
...
mostCurrent._lb.setText((Object)("	ပထမဦးစြာ Install ကိုႏွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font1 ကိုနွိပ္ပါ Love.txj ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ မရခဲ့ရင္ Change Font2 ကိုနွိပ္ျပီး Myanmar Love Font နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။"));
...
mostCurrent._tlb.setText((Object)("Vivo"));
 //BA.debugLineNum = 79;BA.debugLine="tlb.Color = Colors.rgb(244, 67, 54)";
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Vivo Myanmar Font","Love.txj")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Vivo Myanmar Font/Love.txj");};
 //BA.debugLineNum = 136;BA.debugLine="File.Copy(File.DirAssets,\"Love.txj\",File.DirRootE";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Love.txj",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Vivo Myanmar Font","Love.txj");
...
mostCurrent._msg.setText((Object)("File Manager တစ္ခုခုထဲသို႔သြားၿပီး Vivo Myanmar Font ဖိုဒါထဲကိုဝင္ပါ။ Love.txj ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ သို႔မဟုတ္ Change Font2 နဲ႔ထပ္သြင္းၾကည့္ပါ။"));
...
mostCurrent._msg.setText((Object)("Install ကိုႏွိပ္ၿပီးတာနဲ႔ ဖုန္းမွာ Default File Manager တစ္ခုခုမေရြးထားရင္ေတာ့ ကိုယ့္ဘာသာကို ဖုန္းထဲက File Manager တစ္ခုခုထဲကိုသြားလိုက္ပါ။	ၿပီးရင္ Vivo Myanmar Font ဆိုတဲ့ဖိုဒါကိုရွာၿပီး ဝင္လိုက္ပါ။ အဲ့ဖိုဒါထဲမွာ Love.txj ဆိုတဲ့ဖိုင္ေလးကိုဖြင့္ၿပီး Apply ေပးလိုက္ပါ။ အဆင္မေျပတာမ်ားရွိရင္ Facebook က Myanmar Android Apps မွာလာေမးနိုင္ပါတယ္ :)"));
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Download/i Theme/Font","Love.txj")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Download/i Theme/Font/Love.txj");};
 //BA.debugLineNum = 162;BA.debugLine="File.Copy(File.DirAssets,\"Love.txj\",File.DirRootE";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Love.txj",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Download/i Theme/Font","Love.txj");
...
mostCurrent._lb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Love";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 250;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful M";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 228;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Heart+Font");
