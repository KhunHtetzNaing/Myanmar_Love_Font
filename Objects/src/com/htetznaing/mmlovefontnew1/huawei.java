...
public class huawei extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmlovefontnew1", "com.htetznaing.mmlovefontnew1.huawei");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmlovefontnew1", "com.htetznaing.mmlovefontnew1.huawei");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmlovefontnew1.huawei", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/HWThemes","Love.hwt")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Love.hwt");};
 //BA.debugLineNum = 123;BA.debugLine="File.Copy(File.DirAssets,\"Love.hwt\",File.DirRootE";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Love.hwt",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/HWThemes","Love.hwt");
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 207;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful M";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 185;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Heart+Font");
