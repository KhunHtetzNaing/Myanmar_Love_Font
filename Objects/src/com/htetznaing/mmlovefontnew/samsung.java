...
public class samsung extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmlovefontnew", "com.htetznaing.mmlovefontnew.samsung");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmlovefontnew", "com.htetznaing.mmlovefontnew.samsung");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmlovefontnew.samsung", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"myanmarlove.apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeartFont(iFont).apk");
 //BA.debugLineNum = 113;BA.debugLine="Msgbox(\"1. Install Fone App\" & CRLF & \"2. After";
...
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/MyanmarHeartFont(iFont).apk");
 //BA.debugLineNum = 116;BA.debugLine="i.SetType(\"application/vnd.android.package-arch";
...
_i.Initialize("","");
 //BA.debugLineNum = 127;BA.debugLine="i.SetComponent(\"com.android.settings/.flipfont.Fo";
...
case 0: {
 //BA.debugLineNum = 169;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,samsung.getObject());
 break; }
case 1: {
 //BA.debugLineNum = 171;BA.debugLine="StartActivity(Oppo)";
