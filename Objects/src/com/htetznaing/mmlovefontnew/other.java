package com.htetznaing.mmlovefontnew;
...
public class other extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmlovefontnew", "com.htetznaing.mmlovefontnew.other");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmlovefontnew", "com.htetznaing.mmlovefontnew.other");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmlovefontnew.other", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.mmlovefontnew.slidemenu _sm = null;
...
public com.htetznaing.mmlovefontnew.main _main = null;
public com.htetznaing.mmlovefontnew.main2 _main2 = null;
public com.htetznaing.mmlovefontnew.samsung _samsung = null;
public com.htetznaing.mmlovefontnew.oppo _oppo = null;
public com.htetznaing.mmlovefontnew.huawei _huawei = null;
public com.htetznaing.mmlovefontnew.vivo _vivo = null;
public com.htetznaing.mmlovefontnew.tutorial _tutorial = null;
public com.htetznaing.mmlovefontnew.about _about = null;
public com.htetznaing.mmlovefontnew.xiaomi _xiaomi = null;
...
mostCurrent._tlb.setText((Object)("Other [#Root]"));
 //BA.debugLineNum = 112;BA.debugLine="tlb.Color = Colors.rgb(244, 67, 54)";
mostCurrent._tlb.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (244),(int) (67),(int) (54)));
...
mostCurrent._banner.Initialize(mostCurrent.activityBA,"Banner","ca-app-pub-4173348573252986/8928808550");
...
mostCurrent._interstitial.Initialize(mostCurrent.activityBA,"Interstitial","ca-app-pub-4173348573252986/1405541758");
...
anywheresoftware.b4a.phone.PackageManagerWrapper _pm = null;
 //BA.debugLineNum = 578;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
 //BA.debugLineNum = 579;BA.debugLine="Dim in As Intent";
_in = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 580;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 581;BA.debugLine="in = pm.GetApplicationIntent(\"com.xinmei365.fonu\"";
_in = _pm.GetApplicationIntent("com.xinmei365.fonu");
 //BA.debugLineNum = 582;BA.debugLine="If in.IsInitialized Then";
if (_in.IsInitialized()) { 
 //BA.debugLineNum = 583;BA.debugLine="Dim ml As MLfiles";
mostCurrent._ml = new MLfiles.Fileslib.MLfiles();
 //BA.debugLineNum = 584;BA.debugLine="ml.rmrf(File.DirRootExternal & \"/.MyanmarHeartFo";
...
anywheresoftware.b4a.objects.IntentWrapper _in = null;
anywheresoftware.b4a.phone.PackageManagerWrapper _pm = null;
 //BA.debugLineNum = 555;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 556;BA.debugLine="Dim in As Intent";
_in = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 557;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 558;BA.debugLine="in = pm.GetApplicationIntent(\"com.xinmei365.fonu\"";
_in = _pm.GetApplicationIntent("com.xinmei365.fonu");
 //BA.debugLineNum = 559;BA.debugLine="If in.IsInitialized Then";
if (_in.IsInitialized()) { 
 //BA.debugLineNum = 560;BA.debugLine="Dim ml As MLfiles";
mostCurrent._ml = new MLfiles.Fileslib.MLfiles();
 //BA.debugLineNum = 561;BA.debugLine="ml.rmrf(File.DirRootExternal & \"/.MyanmarHeartFo";
mostCurrent._ml.rmrf(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/.MyanmarHeartFont");
 };
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 565;BA.debugLine="Sub ad1_Tick";
 //BA.debugLineNum = 566;BA.debugLine="If Interstitial.Ready Then Interstitial.Show";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();};
 //BA.debugLineNum = 567;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 568;BA.debugLine="End Sub";
return "";
}
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 574;BA.debugLine="Sub ad2_Tick";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 168;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 169;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 170;BA.debugLine="File.Copy(File.DirAssets,\"myanmarlove.ttf\",File.";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"myanmarlove.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeart.ttf");
 //BA.debugLineNum = 171;BA.debugLine="ProgressDialogShow(\"Installing...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Installing...");
 //BA.debugLineNum = 172;BA.debugLine="ti.Enabled = True";
_ti.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 174;BA.debugLine="Msgbox(\"Your device not have Root Access!\",\"Atte";
...
public static String  _b2_click() throws Exception{
 //BA.debugLineNum = 408;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 409;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 410;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 411;BA.debugLine="ProgressDialogShow(\"Please Wait...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Please Wait...");
 //BA.debugLineNum = 412;BA.debugLine="tr.Enabled = True";
_tr.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 414;BA.debugLine="Msgbox(\"Your device not have Root Access!\",\"Atte";
anywheresoftware.b4a.keywords.Common.Msgbox("Your device not have Root Access!","Attention!",mostCurrent.activityBA);
 };
...
public static String  _b3_click() throws Exception{
 //BA.debugLineNum = 551;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 552;BA.debugLine="StartActivity(Tutorial)";
...
mostCurrent._sm = new com.htetznaing.mmlovefontnew.slidemenu();
...
mostCurrent._mm = new anywheresoftware.b4a.keywords.constants.TypefaceWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"myan";
mostCurrent._mm.setObject((android.graphics.Typeface)(mostCurrent._mm.LoadFromAssets("myanmarlove.ttf")));
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 570;BA.debugLine="Sub Interstitial_AdClosed";
 //BA.debugLineNum = 571;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 572;BA.debugLine="End Sub";
return "";
}
public static String  _ist_tick() throws Exception{
 //BA.debugLineNum = 398;BA.debugLine="Sub ist_Tick";
 //BA.debugLineNum = 399;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 400;BA.debugLine="Msgbox(\"Congratulations! Myanmar Installed in you";
anywheresoftware.b4a.keywords.Common.Msgbox("Congratulations! Myanmar Installed in your device"+anywheresoftware.b4a.keywords.Common.CRLF+"Now, your device will be reboot!","Completed",mostCurrent.activityBA);
 //BA.debugLineNum = 401;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 402;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 403;BA.debugLine="ml.RootCmd(\"reboot\",\"\",Null,Null,False)";
mostCurrent._ml.RootCmd("reboot","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 405;BA.debugLine="ist.Enabled = False";
_ist.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 406;BA.debugLine="End Sub";
return "";
}
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 622;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 623;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
public static String  _rst_tick() throws Exception{
 //BA.debugLineNum = 539;BA.debugLine="Sub rst_Tick";
 //BA.debugLineNum = 540;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 541;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 542;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 543;BA.debugLine="Msgbox(\"Congratulations! Original Restored\" & CR";
anywheresoftware.b4a.keywords.Common.Msgbox("Congratulations! Original Restored"+anywheresoftware.b4a.keywords.Common.CRLF+"Now, your device will be reboot!","Completed",mostCurrent.activityBA);
 //BA.debugLineNum = 544;BA.debugLine="ml.RootCmd(\"reboot\",\"\",Null,Null,False)";
mostCurrent._ml.RootCmd("reboot","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 546;BA.debugLine="Msgbox(\"Your device not have Root Access!\",\"Atte";
anywheresoftware.b4a.keywords.Common.Msgbox("Your device not have Root Access!","Attention!",mostCurrent.activityBA);
 };
 //BA.debugLineNum = 548;BA.debugLine="rst.Enabled = False";
_rst.setEnabled(anywheresoftware.b4a.keywords.Common.False);
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 626;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 627;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 628;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 629;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful M";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com");
 //BA.debugLineNum = 630;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 631;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 632;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 633;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 634;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 635;BA.debugLine="StartActivity (ShareIt)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 589;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 590;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 591;BA.debugLine="Select Item";
switch (BA.switchObjectToInt(_item,(Object)(1),(Object)(2),(Object)(3),(Object)(4),(Object)(5),(Object)(6),(Object)(7),(Object)(8),(Object)(9))) {
case 0: {
 //BA.debugLineNum = 593;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,other.getObject());
 break; }
case 1: {
 //BA.debugLineNum = 595;BA.debugLine="StartActivity(Oppo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._oppo.getObject()));
 break; }
case 2: {
 //BA.debugLineNum = 597;BA.debugLine="StartActivity(Vivo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._vivo.getObject()));
 break; }
case 3: {
 //BA.debugLineNum = 599;BA.debugLine="StartActivity(Huawei)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._huawei.getObject()));
 break; }
case 4: {
 //BA.debugLineNum = 601;BA.debugLine="StartActivity(Xiaomi)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._xiaomi.getObject()));
 break; }
case 5: {
 //BA.debugLineNum = 603;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,other.getObject());
 break; }
case 6: {
 //BA.debugLineNum = 605;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 606;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 607;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com");
 //BA.debugLineNum = 608;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 609;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 610;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 611;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 612;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 613;BA.debugLine="StartActivity (ShareIt)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 615;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 616;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetzna";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com")));
 break; }
case 8: {
 //BA.debugLineNum = 618;BA.debugLine="StartActivity(About)";
...
public static String  _ti_tick() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub ti_Tick";
 //BA.debugLineNum = 179;BA.debugLine="ml.RootCmd(\"mount -o rw,remount /system\",\"\",Null,";
mostCurrent._ml.RootCmd("mount -o rw,remount /system","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 180;BA.debugLine="If ml.Exists(\"/system/Ht3tzN4ing.ttf\") = False Th";
if (mostCurrent._ml.Exists("/system/Ht3tzN4ing.ttf")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 181;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /syst";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/Ht3tzN4ing.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 183;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk.ttf\") = True";
if (mostCurrent._ml.Exists("/system/fonts/Padauk.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 184;BA.debugLine="ml.mv(\"/system/fonts/Padauk.ttf\",\"/system/fonts";
mostCurrent._ml.mv("/system/fonts/Padauk.ttf","/system/fonts/Padauk.ttf.bak");
 //BA.debugLineNum = 185;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 186;BA.debugLine="ml.chmod(\"/system/fonts/Padauk.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 190;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-book.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-book.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 191;BA.debugLine="ml.mv(\"/system/fonts/Padauk-book.ttf\",\"/system/";
mostCurrent._ml.mv("/system/fonts/Padauk-book.ttf","/system/fonts/Padauk-book.ttf.bak");
 //BA.debugLineNum = 192;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk-book.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 193;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-book.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk-book.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 197;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-bookbold.ttf\"";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-bookbold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 198;BA.debugLine="ml.mv(\"/system/fonts/Padauk-bookbold.ttf\",\"/sys";
mostCurrent._ml.mv("/system/fonts/Padauk-bookbold.ttf","/system/fonts/Padauk-bookbold.ttf.bak");
 //BA.debugLineNum = 199;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk-bookbold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 200;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-bookbold.ttf\",64";
mostCurrent._ml.chmod("/system/fonts/Padauk-bookbold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 204;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Bold";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 205;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmar-Bold.ttf\",";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmar-Bold.ttf","/system/fonts/NotoSansMyanmar-Bold.ttf.bak");
 //BA.debugLineNum = 206;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmar-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 207;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Bold.tt";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 211;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Regu";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 212;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmar-Regular.tt";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmar-Regular.ttf","/system/fonts/NotoSansMyanmar-Regular.ttf.bak");
 //BA.debugLineNum = 213;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmar-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 214;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Regular";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 218;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Bo";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 219;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarUI-Bold.ttf";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarUI-Bold.ttf","/system/fonts/NotoSansMyanmarUI-Bold.ttf.bak");
 //BA.debugLineNum = 220;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarUI-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 221;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Bold.";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 225;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Re";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 226;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarUI-Regular.";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarUI-Regular.ttf","/system/fonts/NotoSansMyanmarUI-Regular.ttf.bak");
 //BA.debugLineNum = 227;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarUI-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 228;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Regul";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 233;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgy";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 234;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarZawgyi-Bold";
...
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarZawgyi-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 243;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-R";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 247;BA.debugLine="If ml.Exists(\"/system/fonts/SamsungMyanmar.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/SamsungMyanmar.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 248;BA.debugLine="ml.mv(\"/system/fonts/SamsungMyanmar.ttf\",\"/syst";
mostCurrent._ml.mv("/system/fonts/SamsungMyanmar.ttf","/system/fonts/SamsungMyanmar.ttf.bak");
 //BA.debugLineNum = 249;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/SamsungMyanmar.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 250;BA.debugLine="ml.chmod(\"/system/fonts/SamsungMyanmar.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/SamsungMyanmar.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 254;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne.ttf\") = Tr";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 255;BA.debugLine="ml.mv(\"/system/fonts/ZawgyiOne.ttf\",\"/system/fo";
mostCurrent._ml.mv("/system/fonts/ZawgyiOne.ttf","/system/fonts/ZawgyiOne.ttf.bak");
 //BA.debugLineNum = 256;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/ZawgyiOne.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 257;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 261;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne2008.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne2008.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 262;BA.debugLine="ml.mv(\"/system/fonts/ZawgyiOne2008.ttf\",\"/syste";
mostCurrent._ml.mv("/system/fonts/ZawgyiOne2008.ttf","/system/fonts/ZawgyiOne2008.ttf.bak");
 //BA.debugLineNum = 263;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/ZawgyiOne2008.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 264;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne2008.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne2008.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 268;BA.debugLine="If ml.Exists(\"/system/fonts/mmsd.ttf\") = True Th";
if (mostCurrent._ml.Exists("/system/fonts/mmsd.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 269;BA.debugLine="ml.mv(\"/system/fonts/mmsd.ttf\",\"/system/fonts/m";
...
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/mmsd.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 271;BA.debugLine="ml.chmod(\"/system/fonts/mmsd.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/mmsd.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 275;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Regular.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 276;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Regular.ttf\",\"/syst";
mostCurrent._ml.mv("/system/fonts/Roboto-Regular.ttf","/system/fonts/Roboto-Regular.ttf.bak");
 //BA.debugLineNum = 277;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 278;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Regular.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/Roboto-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 281;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Light.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Light.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 282;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Light.ttf\",\"/system";
mostCurrent._ml.mv("/system/fonts/Roboto-Light.ttf","/system/fonts/Roboto-Light.ttf.bak");
 //BA.debugLineNum = 283;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Light.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 284;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Light.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Light.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 287;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Bold.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 288;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Bold.ttf\",\"/system/";
mostCurrent._ml.mv("/system/fonts/Roboto-Bold.ttf","/system/fonts/Roboto-Bold.ttf.bak");
 //BA.debugLineNum = 289;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 290;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Bold.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 293;BA.debugLine="ist.Enabled = True";
_ist.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 294;BA.debugLine="ti.Enabled = False";
_ti.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 299;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk.ttf\") = True";
if (mostCurrent._ml.Exists("/system/fonts/Padauk.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 300;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 301;BA.debugLine="ml.chmod(\"/system/fonts/Padauk.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 305;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-book.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-book.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 306;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk-book.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 307;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-book.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk-book.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 311;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-bookbold.ttf\"";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-bookbold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 312;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk-bookbold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 313;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-bookbold.ttf\",64";
mostCurrent._ml.chmod("/system/fonts/Padauk-bookbold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 317;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Bold";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 318;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmar-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 319;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Bold.tt";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 323;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Regu";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 324;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmar-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 325;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Regular";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 329;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Bo";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 330;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarUI-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 331;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Bold.";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 335;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Re";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 336;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarUI-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 337;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Regul";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 342;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgy";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 343;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarZawgyi-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 344;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-B";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 348;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgy";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 349;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarZawgyi-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 350;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-R";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 354;BA.debugLine="If ml.Exists(\"/system/fonts/SamsungMyanmar.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/SamsungMyanmar.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 355;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/SamsungMyanmar.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 356;BA.debugLine="ml.chmod(\"/system/fonts/SamsungMyanmar.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/SamsungMyanmar.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 360;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne.ttf\") = Tr";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 361;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/ZawgyiOne.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 362;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 366;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne2008.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne2008.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 367;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/ZawgyiOne2008.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 368;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne2008.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne2008.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 372;BA.debugLine="If ml.Exists(\"/system/fonts/mmsd.ttf\") = True Th";
if (mostCurrent._ml.Exists("/system/fonts/mmsd.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 373;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/mmsd.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 374;BA.debugLine="ml.chmod(\"/system/fonts/mmsd.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/mmsd.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 378;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Regular.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 379;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 380;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Regular.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/Roboto-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 383;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Light.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Light.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 384;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Light.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 385;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Light.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Light.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 388;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Bold.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 389;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 390;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Bold.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 393;BA.debugLine="ist.Enabled = True";
_ist.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 394;BA.debugLine="ti.Enabled = False";
_ti.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
...
public static String  _tr_tick() throws Exception{
 //BA.debugLineNum = 418;BA.debugLine="Sub tr_Tick";
 //BA.debugLineNum = 419;BA.debugLine="ml.RootCmd(\"mount -o rw,remount /system\",\"\",Null,";
mostCurrent._ml.RootCmd("mount -o rw,remount /system","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 422;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk.ttf.bak\") = Tr";
if (mostCurrent._ml.Exists("/system/fonts/Padauk.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 423;BA.debugLine="ml.rm(\"/system/fonts/Padauk.ttf\")";
mostCurrent._ml.rm("/system/fonts/Padauk.ttf");
 //BA.debugLineNum = 424;BA.debugLine="ml.mv(\"/system/fonts/Padauk.ttf.bak\",\"/system/fo";
mostCurrent._ml.mv("/system/fonts/Padauk.ttf.bak","/system/fonts/Padauk.ttf");
 //BA.debugLineNum = 425;BA.debugLine="ml.chmod(\"/system/fonts/Padauk.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 429;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-book.ttf.bak\")";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-book.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 430;BA.debugLine="ml.rm(\"/system/fonts/Padauk-book.ttf\")";
mostCurrent._ml.rm("/system/fonts/Padauk-book.ttf");
 //BA.debugLineNum = 431;BA.debugLine="ml.mv(\"/system/fonts/Padauk-book.ttf.bak\",\"/syst";
mostCurrent._ml.mv("/system/fonts/Padauk-book.ttf.bak","/system/fonts/Padauk-book.ttf");
 //BA.debugLineNum = 432;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-book.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk-book.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 436;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-bookbold.ttf.b";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-bookbold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 437;BA.debugLine="ml.rm(\"/system/fonts/Padauk-bookbold.ttf\")";
mostCurrent._ml.rm("/system/fonts/Padauk-bookbold.ttf");
 //BA.debugLineNum = 438;BA.debugLine="ml.mv(\"/system/fonts/Padauk-bookbold.ttf.bak\",\"/";
mostCurrent._ml.mv("/system/fonts/Padauk-bookbold.ttf.bak","/system/fonts/Padauk-bookbold.ttf");
 //BA.debugLineNum = 439;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-bookbold.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/Padauk-bookbold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 443;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Bold.";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Bold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 444;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmar-Bold.ttf\")";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmar-Bold.ttf");
 //BA.debugLineNum = 445;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmar-Bold.ttf.ba";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmar-Bold.ttf.bak","/system/fonts/NotoSansMyanmar-Bold.ttf");
 //BA.debugLineNum = 446;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Bold.ttf";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 450;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Regul";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Regular.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 451;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmar-Regular.ttf";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmar-Regular.ttf");
 //BA.debugLineNum = 452;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmar-Regular.ttf";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmar-Regular.ttf.bak","/system/fonts/NotoSansMyanmar-Regular.ttf");
 //BA.debugLineNum = 453;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Regular.";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 457;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Bol";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Bold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 458;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmarUI-Bold.ttf\"";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmarUI-Bold.ttf");
 //BA.debugLineNum = 459;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarUI-Bold.ttf.";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarUI-Bold.ttf.bak","/system/fonts/NotoSansMyanmarUI-Bold.ttf");
 //BA.debugLineNum = 460;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Bold.t";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 464;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Reg";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Regular.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 465;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmarUI-Regular.t";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmarUI-Regular.ttf");
 //BA.debugLineNum = 466;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarUI-Regular.t";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarUI-Regular.ttf.bak","/system/fonts/NotoSansMyanmarUI-Regular.ttf");
 //BA.debugLineNum = 467;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Regula";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 471;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgyi";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 472;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmarZawgyi-Bold.";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf");
 //BA.debugLineNum = 473;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarZawgyi-Bold.";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf.bak","/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf");
 //BA.debugLineNum = 474;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-Bo";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 478;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgyi";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 479;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmarZawgyi-Regul";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf");
 //BA.debugLineNum = 480;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarZawgyi-Regul";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf.bak","/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf");
 //BA.debugLineNum = 481;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-Re";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 485;BA.debugLine="If ml.Exists(\"/system/fonts/SamsungMyanmar.ttf.ba";
if (mostCurrent._ml.Exists("/system/fonts/SamsungMyanmar.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 486;BA.debugLine="ml.rm(\"/system/fonts/SamsungMyanmar.ttf\")";
mostCurrent._ml.rm("/system/fonts/SamsungMyanmar.ttf");
 //BA.debugLineNum = 487;BA.debugLine="ml.mv(\"/system/fonts/SamsungMyanmar.ttf.bak\",\"/s";
mostCurrent._ml.mv("/system/fonts/SamsungMyanmar.ttf.bak","/system/fonts/SamsungMyanmar.ttf");
 //BA.debugLineNum = 488;BA.debugLine="ml.chmod(\"/system/fonts/SamsungMyanmar.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/SamsungMyanmar.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 492;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne.ttf.bak\") =";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 493;BA.debugLine="ml.rm(\"/system/fonts/ZawgyiOne.ttf\")";
mostCurrent._ml.rm("/system/fonts/ZawgyiOne.ttf");
 //BA.debugLineNum = 494;BA.debugLine="ml.mv(\"/system/fonts/ZawgyiOne.ttf.bak\",\"/system";
mostCurrent._ml.mv("/system/fonts/ZawgyiOne.ttf.bak","/system/fonts/ZawgyiOne.ttf");
 //BA.debugLineNum = 495;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 499;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne2008.ttf.bak";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne2008.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 500;BA.debugLine="ml.rm(\"/system/fonts/ZawgyiOne2008.ttf\")";
mostCurrent._ml.rm("/system/fonts/ZawgyiOne2008.ttf");
 //BA.debugLineNum = 501;BA.debugLine="ml.mv(\"/system/fonts/ZawgyiOne2008.ttf.bak\",\"/sy";
mostCurrent._ml.mv("/system/fonts/ZawgyiOne2008.ttf.bak","/system/fonts/ZawgyiOne2008.ttf");
 //BA.debugLineNum = 502;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne2008.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne2008.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 506;BA.debugLine="If ml.Exists(\"/system/fonts/mmsd.ttf.bak\") = True";
if (mostCurrent._ml.Exists("/system/fonts/mmsd.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 507;BA.debugLine="ml.rm(\"/system/fonts/mmsd.ttf\")";
mostCurrent._ml.rm("/system/fonts/mmsd.ttf");
 //BA.debugLineNum = 508;BA.debugLine="ml.mv(\"/system/fonts/mmsd.ttf.bak\",\"/system/font";
mostCurrent._ml.mv("/system/fonts/mmsd.ttf.bak","/system/fonts/mmsd.ttf");
 //BA.debugLineNum = 509;BA.debugLine="ml.chmod(\"/system/fonts/mmsd.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/mmsd.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 513;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Bold.ttf.bak\")";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Bold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 514;BA.debugLine="ml.rm(\"/system/fonts/Roboto-Bold.ttf\")";
mostCurrent._ml.rm("/system/fonts/Roboto-Bold.ttf");
 //BA.debugLineNum = 515;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Bold.ttf.bak\",\"/syst";
mostCurrent._ml.mv("/system/fonts/Roboto-Bold.ttf.bak","/system/fonts/Roboto-Bold.ttf");
 //BA.debugLineNum = 516;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Bold.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 519;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Light.ttf.bak\"";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Light.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 520;BA.debugLine="ml.rm(\"/system/fonts/Roboto-Light.ttf\")";
mostCurrent._ml.rm("/system/fonts/Roboto-Light.ttf");
 //BA.debugLineNum = 521;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Light.ttf.bak\",\"/sys";
mostCurrent._ml.mv("/system/fonts/Roboto-Light.ttf.bak","/system/fonts/Roboto-Light.ttf");
 //BA.debugLineNum = 522;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Light.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Light.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 525;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Regular.ttf.ba";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Regular.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 526;BA.debugLine="ml.rm(\"/system/fonts/Roboto-Regular.ttf\")";
mostCurrent._ml.rm("/system/fonts/Roboto-Regular.ttf");
 //BA.debugLineNum = 527;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Regular.ttf.bak\",\"/s";
mostCurrent._ml.mv("/system/fonts/Roboto-Regular.ttf.bak","/system/fonts/Roboto-Regular.ttf");
 //BA.debugLineNum = 528;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Regular.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 531;BA.debugLine="If ml.Exists(\"/system/Ht3tzN4ing.ttf\") = True The";
if (mostCurrent._ml.Exists("/system/Ht3tzN4ing.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 532;BA.debugLine="ml.rm(\"/system/Ht3tzN4ing.ttf\")";
mostCurrent._ml.rm("/system/Ht3tzN4ing.ttf");
 };
 //BA.debugLineNum = 535;BA.debugLine="rst.Enabled = True";
_rst.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 536;BA.debugLine="tr.Enabled = False";
_tr.setEnabled(anywheresoftware.b4a.keywords.Common.False);
