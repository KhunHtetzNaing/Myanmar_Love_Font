...
public class oppo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmlovefontnew", "com.htetznaing.mmlovefontnew.oppo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmlovefontnew", "com.htetznaing.mmlovefontnew.oppo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmlovefontnew.oppo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.mmlovefontnew.other _other = null;
...
mostCurrent._lb.setText((Object)("	ပထမဦးစြာ Install ကိုႏွိပ္ျပီး Myanmar Love(iFont) ကို Install လုပ္ေပးလိုက္ပါ။  Install လုပ္လို့ၿပီးရင္ Done ကိုသာနွိပ္ေပးပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Love(iFont) ကိုေရြးေပးလိုက္ပါ။"));
...
mostCurrent._tlb.setText((Object)("Oppo"));
 //BA.debugLineNum = 66;BA.debugLine="tlb.Color = Colors.rgb(244, 67, 54)";
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Sub ad1_Tick";
...
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Sub ad2_Tick";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 ...
 //BA.debugLineNum = 111;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 112;BA.debugLine="File.Copy(File.DirAssets,\"myanmarlove.apk\",File.D";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"myanmarlove.apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeartFont(iFont).apk");
 //BA.debugLineNum = 113;BA.debugLine="Msgbox(\"1. Install Fone App\" & CRLF & \"2. After I";
anywheresoftware.b4a.keywords.Common.Msgbox("1. Install Fone App"+anywheresoftware.b4a.keywords.Common.CRLF+"2. After Installed click done!"+anywheresoftware.b4a.keywords.Common.CRLF+"3. Click Change Font and Choose your Font!","Attention!",mostCurrent.activityBA);
 //BA.debugLineNum = 114;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 115;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"file:///\"&File.DirRoo";
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/MyanmarHeartFont(iFont).apk");
 //BA.debugLineNum = 116;BA.debugLine="i.SetType(\"application/vnd.android.package-archiv";
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 //BA.debugLineNum = 120;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 121;BA.debugLine="If File.Exists(File.DirRootExternal,\"MyanmarHeart";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeartFont(iFont).apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 122;BA.debugLine="File.Delete(File.DirRootExternal,\"MyanmarHeartFo";
...
try { //BA.debugLineNum = 125;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 126;BA.debugLine="i.Initialize(\"\", \"\")";
_i.Initialize("","");
 //BA.debugLineNum = 127;BA.debugLine="i.SetComponent(\"com.android.settings/.flipfont.F";
_i.SetComponent("com.android.settings/.flipfont.FontListActivity");
 //BA.debugLineNum = 128;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 } 
       catch (Exception e10) {
			processBA.setLastException(e10); //BA.debugLineNum = 130;BA.debugLine="Dim abc As Intent";
_abc = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 131;BA.debugLine="abc.Initialize(\"android.settings.DISPLAY_SETTING";
_abc.Initialize("android.settings.DISPLAY_SETTINGS","");
 //BA.debugLineNum = 132;BA.debugLine="StartActivity(abc)";
...
public static String  _b3_click() throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 137;BA.debugLine="If File.Exists(File.DirRootExternal,\"MyanmarHeart";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeartFont(iFont).apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 138;BA.debugLine="File.Delete(File.DirRootExternal,\"MyanmarHeartFo";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeartFont(iFont).apk");
 };
 //BA.debugLineNum = 140;BA.debugLine="StartActivity(Tutorial)";
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Sub Interstitial_AdClosed";
 //BA.debugLineNum = 153;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 154;BA.debugLine="End Sub";
return "";
}
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 199;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 202;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 203;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 204;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 205;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful M";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com");
 //BA.debugLineNum = 206;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 207;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 208;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 209;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 210;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 211;BA.debugLine="StartActivity (ShareIt)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 165;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 166;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 167;BA.debugLine="Select Item";
switch (BA.switchObjectToInt(_item,(Object)(1),(Object)(2),(Object)(3),(Object)(4),(Object)(5),(Object)(6),(Object)(7),(Object)(8),(Object)(9))) {
case 0: {
 //BA.debugLineNum = 169;BA.debugLine="StartActivity(Samsung)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._samsung.getObject()));
 break; }
case 1: {
 //BA.debugLineNum = 171;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,oppo.getObject());
 break; }
case 2: {
 //BA.debugLineNum = 173;BA.debugLine="StartActivity(Vivo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._vivo.getObject()));
 break; }
case 3: {
 //BA.debugLineNum = 175;BA.debugLine="StartActivity(Huawei)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._huawei.getObject()));
 break; }
case 4: {
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(Xiaomi)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._xiaomi.getObject()));
 break; }
case 5: {
 //BA.debugLineNum = 179;BA.debugLine="StartActivity(Other)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._other.getObject()));
 break; }
case 6: {
 //BA.debugLineNum = 181;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 182;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 183;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com");
 //BA.debugLineNum = 184;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 185;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 186;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 187;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 188;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 189;BA.debugLine="StartActivity (ShareIt)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 191;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 192;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetzna";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com")));
 break; }
case 8: {
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(About)";
