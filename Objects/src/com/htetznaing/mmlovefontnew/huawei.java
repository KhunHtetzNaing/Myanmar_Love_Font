...
public class huawei extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmlovefontnew", "com.htetznaing.mmlovefontnew.huawei");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmlovefontnew", "com.htetznaing.mmlovefontnew.huawei");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmlovefontnew.huawei", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setText((Object)("	ပထမဦးစြာ Install ကိုႏွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Love Font နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။"));
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Sub ad1_Tick";
 //BA.debugLineNum = 138;BA.debugLine="If Interstitial.Ready Then Interstitial.Show";
...
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 146;BA.debugLine="Sub ad2_Tick";
...
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"HWThemes");};
 //BA.debugLineNum = 113;BA.debugLine="If File.Exists(File.DirRootExternal & \"/HWThemes\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/HWThemes","myanmarlove.hwt")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"myanmarlove.hwt");};
 //BA.debugLineNum = 114;BA.debugLine="File.Copy(File.DirAssets,\"myanmarlove.hwt\",File.D";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"myanmarlove.hwt",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/HWThemes","myanmarlove.hwt");
 //BA.debugLineNum = 115;BA.debugLine="Msgbox(\"Installed\" & CRLF & \"Now! you can change";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 118;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 119;BA.debugLine="Try";
try { //BA.debugLineNum = 120;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 121;BA.debugLine="i.Initialize(\"\", \"\")";
_i.Initialize("","");
 //BA.debugLineNum = 122;BA.debugLine="i.SetComponent(\"com.huawei.android.thememanager/.";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
			...
			processBA.setLastException(e7); //BA.debugLineNum = 125;BA.debugLine="Msgbox(\"Your phone is not Huawei EMUI\" & CRLF &";
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 130;BA.debugLine="StartActivity(Tutorial)";
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Sub Interstitial_AdClosed";
...
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 189;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 192;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 193;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 194;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 195;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful M";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com");
 //BA.debugLineNum = 196;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 197;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 198;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 199;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 200;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 201;BA.debugLine="StartActivity (ShareIt)";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 173;BA.debugLine="copy.setText(\"#Myanmar_Love_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Love_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com");
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 176;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 181;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 182;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetzna";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com")));
 break; }
case 8: {
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(About)";
